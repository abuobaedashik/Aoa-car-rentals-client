...
const WhyChooseUs = () => {
  return (
    <div>
      <div className="text-4xl font-bold text-center mt-3">Why Choose Us</div>
      ...
      <div className="mt-6 flex md:flex-row flex-col items-center justify-between gap-7 md:gap-2 mb-8">
        <div className="flex flex-col gap-3 items-center justify-center bg-[#ffffff] p-6 rounded-lg hover:text-[#ffffff] hover:bg-[#131313]">
          ...
          <p className="text-2xl font-bold">Wide Variety of Car</p>
          <p className="text-sm font-normal w-[200px] text-center">
        ...
        <div className="flex flex-col gap-3 items-center justify-center bg-[#ffffff] p-6 rounded-lg hover:text-[#ffffff] hover:bg-[#131313]">
          ...
          <p className="text-2xl font-bold">Easy Booking Process</p>
          <p className="text-sm font-normal w-[200px] text-center">
