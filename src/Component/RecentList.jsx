...
const RecentList = () => {
 ...
 console.log(latestSixCars);
  ...
  return <div>
      ...
      <div className="text-base text-center font-medium text-[#1313139f]">Explore the latest additions to our collection of premium cars, offering the best in performance, comfort, and affordability.</div>
      <div className="mt-3 grid md:grid-cols-3 grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-7 shadow-sm">
           {
